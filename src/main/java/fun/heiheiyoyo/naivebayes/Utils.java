package fun.heiheiyoyo.naivebayes;
...
//	public static final String BASE_TRAINDATA_PATH = "data/yt/training";
	public static final String BASE_TRAINDATA_PATH = "datasets/training";
...
//	public static final String BASE_TESTDATA_PATH = "data/yt/test";
	public static final String BASE_TESTDATA_PATH = "datasets/test";
